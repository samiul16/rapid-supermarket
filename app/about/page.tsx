              ...
              <div className="space-y-6">
                ...
                <motion.div className="space-y-4" variants={fadeInUp}>
                  <p className="text-zinc-600 text-base lg:text-lg leading-relaxed">
                    ...
                    Established in 2020, we started as a small dining spot with
                    a big dream — to bring people together over food that feels
                    like home.
                  </p>
                  ...
                  <p className="text-zinc-600 text-base lg:text-lg leading-relaxed">
                    ...
                    heart, heritage, and honest taste. Over the years, our name
                    has become a symbol of consistency, taste, and trust.
                  </p>
                </motion.div>
              </div>
